...
- [x] **API-02**: POST /run-pipeline triggers full pipeline run, writes status to Supabase pipeline_runs table
- [x] **API-03**: POST/GET /labels/{sampleId} persists and retrieves panel label data via Supabase
